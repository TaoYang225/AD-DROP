...
def parse_opt():
    ...
    parser.add_argument('--train_data_path', type=str, default='data/MNLI/train.tsv', help='training set path')
    parser.add_argument('--dev_data_path', type=str, default='data/MNLI/dev_matched.tsv', help='development set path')
    parser.add_argument('--test_data_path', type=str, default='data/MNLI/test_matched.tsv', help='test set path')
