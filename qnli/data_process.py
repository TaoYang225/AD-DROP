...
def parse_opt():
    ...
    parser.add_argument('--train_data_path', type=str, default='data/QNLI/train.tsv', help='training set path')
    parser.add_argument('--dev_data_path', type=str, default='data/QNLI/dev.tsv', help='development set path')
    parser.add_argument('--test_data_path', type=str, default='data/QNLI/test.tsv', help='test set path')
