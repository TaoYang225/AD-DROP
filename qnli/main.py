...
def parse_opt():
    '''hyper_parameters
    '''
    parser = argparse.ArgumentParser(description = 'Run AD-DROP on QNLI')
    ...
    parser.add_argument('--patient', type=int, default=3, help='patient of early stopping')
...
if __name__ == '__main__':
    ...
    if args.option == 'train':
        ...
        with open('QNLI.tsv', 'w', newline='') as f:
