...
def parse_opt():
    ...
    parser.add_argument('--train_data_path', type=str, default='data/STS-B/train.tsv', help='training set path')
    parser.add_argument('--dev_data_path', type=str, default='data/STS-B/dev.tsv', help='development set path')
    parser.add_argument('--test_data_path', type=str, default='data/STS-B/test.tsv', help='test set path')
...
def tokenizer_text(args, texts, max_len, tokenizer, is_test=False):
    ...
    for i,text in enumerate(texts):
        ...
        if is_test:
            ...
            label_id = text['label']
        #
        data.append({'text_a':text['text_a'].strip(), 'text_b':text['text_b'].strip(), 'tokens_id': input_ids, 'attention_mask':input_mask, 'segment_ids':segment_ids, 'label':label_id})
