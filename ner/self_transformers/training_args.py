...
class TrainingArguments:
    ...
    #user arguments
    do_mask: bool = field(default=False, metadata={"help": "Whether do addrop."})
    g_dropout: float = field( default=0.3, metadata={"help": "drop rate."} )
    keep_rate: float = field(default=0.6, metadata={"help": "drop rate."})
