...
def parse_opt():
    ...
    parser.add_argument('--bert_path', type = str, default = 'bert-base-uncased', help = 'path to pre-trained model BERT/RoBERTa')
    parser.add_argument('--model', type=str, default='BERT', choices=['RoBERTa', 'BERT'], help='choice of the used model')

    parser.add_argument('--train_data_path', type=str, default='data/CoLA/train.tsv', help='set training set path')
    parser.add_argument('--dev_data_path', type=str, default='data/CoLA/dev.tsv', help='set development set path')
    parser.add_argument('--test_data_path', type=str, default='data/CoLA/test.tsv', help='set test set path')
    parser.add_argument('--max_len', type = int, default = 47, help = 'sequence length')
