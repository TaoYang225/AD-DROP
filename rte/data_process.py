...
def parse_opt():
    ...
    parser.add_argument('--train_data_path', type=str, default='data/RTE/train.tsv', help='training set path')
    parser.add_argument('--dev_data_path', type=str, default='data/RTE/dev.tsv', help='development set path')
    parser.add_argument('--test_data_path', type=str, default='data/RTE/test.tsv', help='test set path')
    parser.add_argument('--max_len', type = int, default = 128, help = 'sequence length')
