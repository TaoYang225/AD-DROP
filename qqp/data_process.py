...
def parse_opt():
    ...
    parser.add_argument('--bert_path', type = str, default = 'roberta-base', help = 'path to pre-trained model BERT/RoBERTa') # roberta-base  / bert-base-uncased
    parser.add_argument('--model', type=str, default='RoBERTa', choices=['RoBERTa', 'BERT'], help='choice of the used model')

    parser.add_argument('--train_data_path', type=str, default='data/QQP/train.tsv', help='training set path')
    parser.add_argument('--dev_data_path', type=str, default='data/QQP/dev.tsv', help='development set path')
    parser.add_argument('--test_data_path', type=str, default='data/QQP/test.tsv', help='test set path')
    parser.add_argument('--max_len', type = int, default = 120, help = 'sequence length')
